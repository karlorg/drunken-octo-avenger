...
(function() {
  var clearGamesForPlayer, createGame, createLoginSession, defaultHost, host, numGamesForPlayer, port, portString, serverUrl;
  ...
  casper.test.begin("Status Listings", 6, function(test) {
    ...
    assertNumGames = function(player, players_turn, players_wait) {
      ...
      return casper.thenOpen(serverUrl, function() {
        ...
        return test.assertEqual(game_counts.not_your_turn, players_wait);
      });
    };
  ...
  numGamesForPlayer = function(email) {
