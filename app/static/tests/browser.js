...
(function() {
  var BrowserTest, StatusTest, clearGamesForPlayer, createGame, createLoginSession, defaultHost, host, pointSelector, port, portString, serverUrl, status_test,
  ...
  BrowserTest = (function() {
    function BrowserTest(description, num_tests) {
