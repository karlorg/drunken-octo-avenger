...
(function() {
  var BrowserTest, ChallengeTest, ClientSideJsTest, GameInterfaceTest, LoginTest, PlaceStonesTest, StatusTest, clearGamesForPlayer, createGame, createLoginSession, defaultHost, host, pointSelector, port, portString, registerTest, runAll, runTest, serverUrl, testObjects,
  ...
  registerTest = function(className, test) {
    return testObjects[className] = test;
  };
  ...
  runAll = function() {
    var name, results;
    results = [];
    for (name in testObjects) {
      if (!hasProp.call(testObjects, name)) continue;
