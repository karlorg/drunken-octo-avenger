...
(function() {
  var $pointAt, aCode, colRe, colorFromDom, decodeSgfCoord, encodeSgfCoord, game_common, getInputSgf, go_rules, hasCoordClass, parseCoordClass, readBoardState, rowRe, setPointColor, setStoneClass, smartgame, tesuji_charm, updateBoard,
    ...
    stoneclass = (function() {
      switch (color) {
        ...
        case 'white':
          return 'whitestone';
        case 'blackdead':
          return 'blackdead whitescore';
        case 'whitedead':
          return 'whitedead blackscore';
        case 'blackscore':
          return 'blackscore nostone';
        case 'whitescore':
          return 'whitescore nostone';
      }
    })();
