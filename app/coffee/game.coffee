...
exports.initialize = (sgfObject = null, newStoneColor = null) ->
  ...
  # confirm button not under React control as it's provided by WTForms
  ...
  render: ->
    ...
    if (tesuji_charm.onTurn and \
      ...
      onPlaceStone = (xy) =>
        ...
        newSgfObject = sgfObjectWithMoveAdded @props.sgfObject,
                                              xy.x, xy.y, nextColor
...
sgfObjectWithMoveAdded = (sgfObject, col=null, row=null, color=null) ->
